...
struct Record {
    ...
    int GetRecordSize() { return record_size + sizeof(tr_s) + sizeof(tr_e) + sizeof(commited); };
    char *GetRecordBuf() {
        ...
        offset += sizeof(tr_e);
        std::memcpy(&result[offset], &commited, sizeof(commited));
        offset += sizeof(tr_e);
        return result;
    };
    ...
    void SetRecord(char *buf) {
        ...
        offset += sizeof(tr_e);
        std::memcpy(&commited, &buf[offset], sizeof(commited));
    };
