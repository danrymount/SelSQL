...
buffer_data GetDataBlockBuffer(DataBlock *data_block) { return buffer_data(); }
std::shared_ptr<DataBlock> ReadDataBlockFromBuffer(char *data) { return std::shared_ptr<DataBlock>(); }
